      ...
      <div class="product-page__wrapper">
        ...
        <div class="product-page__buttons-red">
          ...
          <a class="
                        ...
                        btn btn--success
                        popups-init-js
                      " href="#!" rel="slide-add-layer">Добавить слой</a>

          <a class="
                        product-page__button-choice
                        btn btn--success
                        popups-init-js
                      " href="#!" rel="slide-bord">ВЫБРАТЬ БОРТИК</a>
        </div>
...
?>
        ...
        <div class="product-page__buttons-type">
          <a class="product-page__button-type1 _button-type-active" href="#!">458 ГР</a>
...
<?php require get_template_directory() . '/includes/modals.php'; ?>
