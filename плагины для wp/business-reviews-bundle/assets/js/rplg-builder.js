...
function rplg_builder_init(data) {
    ...
    WPacFastjs.on2(el, '.rplg-connect-facebook', 'click', function() {
        ...
        var temp_code = rplg_randstr(16);
        rplg_popup('https://app.widgetpack.com/auth/fbrev?scope=pages_show_list,pages_read_user_content,pages_read_engagement,manage_pages&state=' + temp_code, 670, 520, function() {
